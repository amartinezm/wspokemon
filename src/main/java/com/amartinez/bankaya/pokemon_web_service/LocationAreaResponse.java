 ...
 *       &lt;sequence>
 *         &lt;element name="locationArea" type="{http://amartinez.com/bankaya/pokemon-web-service}locationArea" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "locationAreaResponse")
public class LocationAreaResponse {

    protected List<String> locationArea;
     ...
     * 
     */
    public List<String> getLocationArea() {
        if (locationArea == null) {
            locationArea = new ArrayList<String>();
        }
